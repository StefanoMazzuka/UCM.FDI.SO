...
int rr_quantum=3; // quantum por defecto
...
static void task_new_rr(task_t* t){
    ...
    t->quantum_privado = rr_quantum;    
    t->remaining_ticks_slice= t->quantum_privado;	
}
